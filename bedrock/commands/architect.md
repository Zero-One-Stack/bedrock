...
2. **Data & state plan** — server reads (entity `api/` queries — RSC + React Query — to scaffold/reuse) vs. server writes (feature `api/` Server Actions) vs. client vs. form state.
